...
# Generated by examples/xgboost-diabetes-regression/init-example.sh
#
# This configuration enables the services required for the
# XGBoost diabetes regression Spark end-to-end example:
...
echo "     See examples/xgboost-diabetes-regression/README.md"
echo ""
