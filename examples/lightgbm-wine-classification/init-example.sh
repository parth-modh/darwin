...
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║   LightGBM Wine Classification Spark Example - Quick Setup     ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
echo "📋 Generating configuration for lightgbm-wine-classification example..."
echo ""

# Generate the enabled-services.yaml
cat > "$OUTPUT_FILE" << 'EOF'
# Darwin Distribution - Enabled Services Configuration
# Generated by examples/lightgbm-wine-classification/init-example.sh
#
# This configuration enables the services required for the
# LightGBM wine classification Spark end-to-end example:
...
echo "     See examples/lightgbm-wine-classification/README.md"
echo ""
